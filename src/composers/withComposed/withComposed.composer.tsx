...
const withComposed = <T extends object>(
  ...
  // ✅ 2. Handle Custom Props Injection
  ...
  const EnhancedComponent = compose(...enhancers)(Component as any);
  const WrappedComponent: React.FC<T> = (props) => <EnhancedComponent {...props} />;
  WrappedComponent.displayName = 'withComposed';
